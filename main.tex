...
\title{True or False Face Detection}
%
%
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{Figures/2-A-(3).png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{Figures/2-A-(4).png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{Figures/2-A-(1).png}
